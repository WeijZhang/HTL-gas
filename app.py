...
if st.button('Predict'):
    ...
    # 在三列中显示预测结果
    col1.write(f'CO2 (mol/kg): prediction[0, 0]')
    col2.write(f'CH4 (mol/kg):  prediction[0, 1]')
    col3.write(f'CO (mol/kg): prediction[0, 2]')
    col4.write(f'H2 (mol/kg): prediction[0, 3]')
else:
    # 按钮未点击时也在三列中显示标签
